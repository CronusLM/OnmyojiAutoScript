...
class RyouToppaAssets: 
	...
	# 勋章奖励标题 
	I_GUILD_ORDERS_REWARDS = RuleImage(roi_front=(222,464,72,56), roi_back=(222,464,72,56), threshold=0.7, method="Template matching", file="./tasks/RyouToppa/res/res_guild_orders_rewards.png")
	# 攻破阴阳寮 
