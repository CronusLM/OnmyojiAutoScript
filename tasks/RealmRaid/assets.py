...
class RealmRaidAssets: 
	...
	# 进攻 
	I_FIRE = RuleImage(roi_front=(982,626,136,63), roi_back=(140,129,1024,584), threshold=0.8, method="Template matching", file="./tasks/RealmRaid/res/res_fire.png")
	# 打完个后出现的领取奖励 
	...
	# 已经进攻三次了 
	I_RR_THREE = RuleImage(roi_front=(428,584,42,46), roi_back=(428,584,42,46), threshold=0.8, method="Template matching", file="./tasks/RealmRaid/res/res_rr_three.png")
	# 呱太入侵， 第一次进入结界时候出现 
