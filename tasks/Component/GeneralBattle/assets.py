...
class GeneralBattleAssets: 
	...
	# 退出确认 
	I_EXIT_ENSURE = RuleImage(roi_front=(674,394,135,63), roi_back=(674,394,135,63), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBattle/gb/gb_exit_ensure.png")
	# 左上角好友图标 
