...
class GeneralRoomAssets: 
	...
	# description 
	I_CREATE_ENSURE = RuleImage(roi_front=(533,484,219,63), roi_back=(533,484,219,63), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralRoom/gr/gr_create_ensure.png")
	# 勾选不公开的图 
